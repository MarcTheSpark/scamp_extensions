...
note_handle = viola.start_note(60, 1.0, fixed=False)
note_handle.change_pitch(67, 3)
wait(3)
note_handle.end()
note_handle = viola.start_note(67, 1.0, preset="pizz", fixed=False)
note_handle.change_pitch(60, 1)
wait(1)
note_handle.end()
note_handle = viola.start_note(60, 1.0, preset="pizz", fixed=False)
