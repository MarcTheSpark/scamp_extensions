"""
Contains the MetricStructure class, which provides a highly flexible representation of a metric hierarchy, showing
how represents the beat/subdivision groups of a beat, measure or other span of
